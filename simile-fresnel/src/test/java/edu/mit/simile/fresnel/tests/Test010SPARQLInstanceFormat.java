...
public class Test010SPARQLInstanceFormat extends BaseTest {
	final static protected Logger logger = Logger.getLogger(Test010SPARQLInstanceFormat.class);
	
	private final static File _onto = new File("data/ontologies/foaf.rdf");
	private final static File _data = new File("data/test10/in.rdf");
	private final static File _config = new File("data/test10/config.n3");
	private final static File _out = new File("data/test10/out.xml");
		
	public Test010SPARQLInstanceFormat(String name) {
		super(name);
	}
