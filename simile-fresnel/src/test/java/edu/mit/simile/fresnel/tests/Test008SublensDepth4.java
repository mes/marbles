...
public class Test008SublensDepth4 extends BaseTest {
	final static protected Logger logger = Logger.getLogger(Test008SublensDepth4.class);
	
	private final static File _onto = new File("data/ontologies/foaf.rdf");
	private final static File _data = new File("data/test8/in.rdf");
	private final static File _config = new File("data/test8/config.n3");
	private final static File _out = new File("data/test8/out.xml");
		
	public Test008SublensDepth4(String name) {
		super(name);
	}
