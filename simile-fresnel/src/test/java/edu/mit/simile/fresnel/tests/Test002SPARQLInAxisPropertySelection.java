...
public class Test002SPARQLInAxisPropertySelection extends BaseTest {
	final static protected Logger logger = Logger.getLogger(Test002SPARQLInAxisPropertySelection.class);
	
	private final static File _onto = new File("data/ontologies/foaf.rdf");
	private final static File _data = new File("data/test4/in.rdf");
	private final static File _config = new File("data/test4/config.n3");
	private final static File _out = new File("data/test4/out.xml");
		
	public Test002SPARQLInAxisPropertySelection(String name) {
		super(name);
	}
