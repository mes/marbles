...
public class Test009SPARQLPropertyDescription extends BaseTest {
	final static protected Logger logger = Logger.getLogger(Test009SPARQLPropertyDescription.class);
	
	private final static File _onto = new File("data/ontologies/foaf.rdf");
	private final static File _data = new File("data/test9/in.rdf");
	private final static File _config = new File("data/test9/config.n3");
	private final static File _out = new File("data/test9/out.xml");
		
	public Test009SPARQLPropertyDescription(String name) {
		super(name);
	}
