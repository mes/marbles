		...
		<html xml:lang="en-US" lang="en-US">
			...
			<body onload="init()" onresize="setupDimensions()">
				<div id="canvas">
					...
					<div id="footer">
						<div id="footerLeft">Generated by <a href="http://mes.github.com/marbles">Marbles</a></div>
						<div id="footerRight"><a href="http://mes-semantics.com">Linked Data by mes|semantics</a></div>
					</div>
				</div>
			</body>
		</html>
